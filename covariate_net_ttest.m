function [power, elapsed] = covariate_net_ttest(n1, n2, N, sigma0, sigma1, theta, rho_in, rho_out, cluster_size, FWER_threshold, M_rep, M_perm)
...
parfor m = 1:M_rep
    ...
    [W1,Wp, Clist_GT, case_mtx, ctrl_mtx, threshold_GT] = sampling_ind_ttest(n1, n2, N, sigma0, sigma1, theta, cluster_size, rho_in, rho_out);
    % greedy
